...
public abstract class SpringBootTestCaseBase extends AbstractTestNGSpringContextTests {
    /**
     * The constant logger.
     */
    protected static Logger logger = Logger.getLogger(SpringBootTestCaseBase.class);
